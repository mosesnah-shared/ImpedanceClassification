...
if __name__ == "__main__":
    ...
    if turn_on_cross_valid:
        ...
        model_save_path = "models/binary_classification_cylinder_nn_cv.pth"
        ...
        model_save_path = "models/binary_classification_cylinder_nn_no_cv.pth"
